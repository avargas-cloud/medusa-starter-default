...
const CategoryIncludeDescendantsWidget = ({ data }: DetailWidgetProps<CategoryWithMetadata>) => {
    ...
    const handleToggle = async (checked: boolean) => {
        ...
        try {
            ...
            console.log(`[DESCENDANTS] Updated category ${data.id}: include_descendants_tree=${checked}`)
        ...
        <Container className="divide-y p-0">
            ...
            <div className="px-6 py-3 bg-ui-bg-subtle">
                <Text className="text-xs text-ui-fg-muted">
                    <strong>Yes:</strong> Show products from this category AND all subcategories
                    <br />
                    <strong>No:</strong> Show only products directly assigned to this category
                </Text>
            </div>
        </Container>
    )
