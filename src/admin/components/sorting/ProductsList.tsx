...
export const ProductsList = ({
    ...
    console.log("[ProductsList] Ordered items:", orderedProducts.map(p => p.title))
    console.log("[ProductsList] Unordered items:", unorderedProducts.map(p => p.title))
    console.log("[ProductsList] Final render order:", allProducts.map(p => p.title))

    return (
        <Container className="h-full flex flex-col">
            <Heading level="h2" className="mb-4">Products</Heading>
