...
export const SubcategoriesList = ({
  ...
  console.log(
    "[SubcategoriesList] Ordered items:",
    orderedSubcategories.map((s) => s.name)
  );
  console.log(
    "[SubcategoriesList] Unordered items:",
    unorderedSubcategories.map((s) => s.name)
  );
  console.log(
    "[SubcategoriesList] Final render order:",
