import { Button, FocusModal, Heading, Badge, Text, Checkbox } from "@medusajs/ui"
...
const SortableFilterItem = ({ attribute, isNew }: { attribute: Attribute; isNew?: boolean }) => {
    const {
...
export const ManageFiltersModal = ({
    ...
    const [overrideInheritance, setOverrideInheritance] = useState(initialOverride)
                ...
                <FocusModal.Body className="flex-1 overflow-hidden">
                    <div className="flex flex-col gap-4 h-full">
                        ...
                        <div className="flex items-center gap-3 p-4 bg-ui-bg-subtle rounded flex-shrink-0">
                            ...
                            />
                            <div className="flex-1">
                                <Text size="small" weight="plus">Override parent category filters</Text>
                        ...
                        <div className="grid grid-cols-2 gap-4 flex-1 min-h-0">
                            ...
                            <div className="flex flex-col h-full">
                                <div className="flex items-center gap-2 mb-2 flex-shrink-0">
                                    <Heading level="h3" className="text-sm">Active Filters</Heading>
                                    <Badge size="small" color="green">{activeIds.length}</Badge>
                                </div>
                            ...
                            <div className="flex flex-col h-full">
                                <div className="flex items-center gap-2 mb-2 flex-shrink-0">
                                    <Heading level="h3" className="text-sm">Available Filters</Heading>
                                            ...
                                            {inactiveAttrs.map(attr => (
                                                ...
                                                >
                                                    <div className="flex-1">
                                                        ...
                                                        <Text className="text-ui-fg-muted text-xs">{attr.handle}</Text>
                                                    </div>
