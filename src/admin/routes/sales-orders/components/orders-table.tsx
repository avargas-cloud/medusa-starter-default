...
const COLS =
  "grid-cols-[80px_110px_110px_minmax(120px,1fr)_minmax(120px,1fr)_120px_120px_110px_110px_70px]";
const HEADERS = [
  "Order #",
  "QB Ref #",
  "Date",
  ...
  return (
    <div className="min-w-[900px]">
      ...
      {paginated.map((order) => {
        ...
        const invArr = Array.isArray(order.metadata?.qb_invoices)
        ...
        return (
          ...
          >
            ...
            <div>
              <Badge
                color={PAYMENT_COLORS[order.payment_status] ?? "grey"}
                size="small"
              >
            ...
            <div>
              <Badge
                color={FULFILLMENT_COLORS[order.fulfillment_status] ?? "grey"}
                size="small"
              >
...
export const OrdersFooter = ({
  ...
  <div className="flex items-center justify-between px-4 py-3">
    <Text size="xsmall" className="text-ui-fg-muted">
      {!loading &&
        `${sorted.length} ${itemLabel}${sorted.length !== 1 ? "s" : ""}`}
    </Text>
    {totalPages > 1 && (
