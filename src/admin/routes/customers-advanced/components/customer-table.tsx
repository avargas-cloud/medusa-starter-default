    ...
    return (
      <div className="flex h-[400px] w-full items-center justify-center text-ui-fg-subtle">
        <div className="text-center">
          <p className="font-medium text-ui-fg-error">
          ...
          {data.hits.map((customer) => (
            ...
            >
              ...
              <Table.Cell>
                ...
                >
                  <Badge
                    size="small"
                    color={
                      customer.customer_type === "Wholesale" ? "blue" : "grey"
                    }
                  >
                  ...
                  {(() => {
                    ...
                    const groupLevel = customer.groups?.includes("Wholesale")
                      ...
                      : customer.groups?.length > 0
                        ...
                        : null;
                    const level =
                      groupLevel ?? customer.price_level ?? "Retail";
                    return (
                      <Badge
                        size="small"
                        color={level === "Wholesale" ? "green" : "grey"}
                      >
                        {level}
                      </Badge>
                    );
              ...
              <Table.Cell>
                ...
                >
                  <StatusBadge
                    color={customer.has_account ? "green" : "orange"}
                    className="text-xs"
                  >
