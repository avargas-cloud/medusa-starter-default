...
export const fmt = (v: number, c: string) =>
    new Intl.NumberFormat("en-US", { style: "currency", currency: c.toUpperCase() }).format(v)
...
export const addrToLines = (a: Partial<AddrForm> | undefined, fallbackCompany?: string): string[] =>
    !a ? [] : [
