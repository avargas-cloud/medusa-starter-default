...
export const useDraftOrderDetail = (id: string | undefined) => {
  ...
  const shipping = useOrderShipping({
    id,
    setOrder,
    selectedOption,
    customAmount,
    saving: shippingSaving,
    setSaving: setShippingSaving,
    closeModal,
  });
  const {
    handleAddShipping,
  ...
  const {
    ...
    syncError,
    handleSync,
    metadataForm: actMetadataForm,
    setMetadataForm: actSetMetadataForm,
    metaNewKey: actMetaNewKey,
    setMetaNewKey: actSetMetaNewKey,
    metaNewVal: actMetaNewVal,
    setMetaNewVal: actSetMetaNewVal,
    handleAddMetaKey,
  } = actions;
