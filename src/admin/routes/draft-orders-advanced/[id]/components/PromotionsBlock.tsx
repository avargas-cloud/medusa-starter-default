    ...
    return (
        <Container className="p-0 overflow-hidden">
            <div className="px-6 py-4">
                ...
                <InlinePromoInput orderId={orderId} onApplied={onApplied} appliedCodes={promotions.map(p => p.code)} />
                {promotions.length > 0 && (
                    <div className="mt-3 space-y-1.5">
                        {promotions.map((p: any) => (
                            <div key={p.id} className="flex items-center justify-between bg-ui-bg-subtle rounded px-3 py-2 group">
