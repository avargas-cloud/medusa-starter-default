    ...
    <div className="flex items-center justify-between px-6 py-4">
      <div>
        <button
          ...
          className="text-ui-fg-muted text-xs mb-1 hover:text-ui-fg-base"
        >
          ← Draft Orders
        </button>
        ...
        <Text size="small" className="text-ui-fg-subtle">
          {fmtDate(createdAt)} ·{" "}
          <span className="text-ui-fg-muted">{scName}</span>
        </Text>
      </div>
      <div className="flex items-center gap-2">
        {onPrintEstimate && (
        ...
        <DropdownMenu>
          ...
          <DropdownMenu.Content>
            <DropdownMenu.Item
              className="gap-x-2"
              onClick={() => onOpenModal("sales-channel")}
            >
            ...
            >
              <ArrowUpRightOnBox className="text-ui-fg-subtle" /> Open native
              editor
            </DropdownMenu.Item>
