                ...
                <div className="absolute right-0 top-full mt-1 z-50 min-w-[200px] bg-ui-bg-base border border-ui-border-base rounded-lg shadow-xl overflow-hidden">
                    ...
                    {defaultOptions.map(opt => {
                        ...
                        return (
                            ...
                            >
                                <Text size="small" className={isActive ? "font-semibold text-ui-fg-interactive" : "text-ui-fg-base"}>
                                    {opt.label}
                                </Text>
                                <Text size="small" className="tabular-nums text-ui-fg-base font-medium">
