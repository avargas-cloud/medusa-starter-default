...
const PRESETS = [
  {
    label: "Payment Terms",
    text: "Payment is due within 30 days of estimate approval. A 50% deposit is required to begin work.",
  },
  {
    label: "Lead Time",
    text: "Lead time: 5-7 business days from order confirmation. Installation scheduling will be coordinated upon approval.",
  },
  {
    label: "Validity",
    text: "This estimate is valid for 30 days from the date issued. Prices are subject to change after expiration.",
  },
  {
    label: "Warranty",
    text: "All products carry manufacturer warranty. Installation work is warranted for 1 year from completion date.",
  },
  {
    label: "Scope Note",
    text: "Scope of work includes: [describe scope]. Materials, labor, and cleanup are included unless otherwise stated.",
  },
];
  ...
  return (
    <div className="px-6 py-4">
      ...
      <div className="flex flex-wrap gap-2 mb-3">
        <Text size="xsmall" className="text-ui-fg-muted self-center mr-1">
          Templates:
        </Text>
        {PRESETS.map((p) => (
          <button
