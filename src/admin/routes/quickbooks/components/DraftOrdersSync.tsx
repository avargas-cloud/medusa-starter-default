...
export const DraftOrdersSync = () => {
    ...
    const fetchDraftOrders = async () => {
        ...
        try {
            ...
            const unsynced = allDrafts.filter(
                (o) => !o.metadata?.qb_estimate_txn_id
            )
            setOrders(unsynced)
        } catch (err) {
    ...
    return (
        <Container className="p-6">
            ...
            {loading && (
                <Text size="small" className="text-ui-fg-muted">Loading draft orders...</Text>
            )}
                            ...
                            >
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2 mb-1">
                                        ...
                                        <Badge color="grey" size="small">{order.status}</Badge>
                                    </div>
                                    ...
                                    {result?.success && (
                                        <Text size="xsmall" className="text-ui-fg-subtle mt-1">
                                            ✅ QB Estimate: {result.qbEstimateRef || result.qbEstimateTxnId}
                                        </Text>
                                    )}
            ...
            <div className="mt-4 p-3 bg-ui-bg-subtle rounded-md">
                <Text size="xsmall" className="text-ui-fg-muted">
                    ...
                    When the draft is converted to an order, the estimate will be converted to a Sales Order automatically.
                </Text>
            </div>
        </Container>
    )
