/**
 * src/api/store/document-templates/route.ts
 * GET  /store/document-templates   — list templates
 * POST /store/document-templates   — create template
 *
 * Lives under /store/ so Medusa framework applies storeCors automatically.
 * The STORE_CORS env var on Railway includes ecopowertech-store-pos.vercel.app.
 */
...
export const GET = async (req: MedusaRequest, res: MedusaResponse) => {
    ...
    try {
        ...
        console.error("[Store/DocumentTemplates] GET list error:", err)
...
export const POST = async (req: MedusaRequest, res: MedusaResponse) => {
    ...
    try {
        ...
        console.error("[Store/DocumentTemplates] POST create error:", err)
