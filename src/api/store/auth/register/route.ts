...
export const POST = async (req: MedusaRequest, res: MedusaResponse) => {
  ...
  try {
    ...
    if (existingCustomer && !existingCustomer.has_account) {
      ...
      console.log(
        "🎯 Legacy customer -",
        isLegacy ? "sending activation email" : "not legacy"
      );

      if (isLegacy) {
        return handleLegacyCustomerActivation(
          req,
          res,
          existingCustomer,
          password
    ...
    // CASE 1: New customer
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    return handleNewCustomerRegistration(req, res, {
      email,
      password,
      first_name,
      last_name,
