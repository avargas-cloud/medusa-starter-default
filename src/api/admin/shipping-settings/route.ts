...
export async function POST(
    ...
    try {
        ...
        if (regular_ground_shipping_price !== undefined && regular_ground_shipping_price < 0) {
            res.status(400).json({
        ...
        if (long_item_ground_shipping_price !== undefined && long_item_ground_shipping_price < 0) {
            res.status(400).json({
