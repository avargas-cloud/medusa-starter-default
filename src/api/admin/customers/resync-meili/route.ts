...
export const POST = async (req: MedusaRequest, res: MedusaResponse) => {
    ...
    try {
        logger.info(`[resync-meili] Starting customer MeiliSearch resync (offset=${offset}, limit=${limit || 'all'})`)
        ...
        logger.info(`[resync-meili] Processing ${customers.length} customers (total: ${total})`)
        ...
        logger.info(`[resync-meili] ✅ Done — ${synced} customers synced to MeiliSearch`)
