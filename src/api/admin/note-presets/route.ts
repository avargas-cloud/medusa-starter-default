...
const DEFAULT_PRESETS = [
  ...
  },
  {
    ...
    sort_order: 2,
    content:
      "LEAD TIME: Standard lead time is 5–7 business days from order confirmation. Lead times may vary based on product availability and order volume.",
  },
  {
    group_name: "Store Policy",
    title: "Validity",
    sort_order: 3,
    content:
      "QUOTE VALIDITY: This quote is valid for 30 calendar days from the date of issue. After this period, prices are subject to change without notice.",
  },
  {
    group_name: "Store Policy",
    title: "Warranty",
    sort_order: 4,
    content:
      "WARRANTY: Products are warranted for 5 years from the date of purchase against manufacturing defects under normal use conditions.",
  },
  {
    group_name: "Store Policy",
    title: "Scope Note",
    sort_order: 5,
    content:
      "SCOPE: This quote covers only the items listed in the bill of materials. Any additional items, services, or modifications will require a separate quote.",
  },
  // Scope of Work
  {
    ...
    sort_order: 1,
    content:
      "This estimate covers the supply of specified materials and equipment only, as outlined in the bill of materials. Installation, configuration, labor, or any other services are not included unless explicitly stated.",
  },
  {
    group_name: "Scope of Work",
    ...
    sort_order: 2,
    content:
      "This estimate includes custom fabrication of components per the approved design specifications. Changes to design or scope after approval may affect pricing and lead times and will require a written change order.",
  },
  {
    group_name: "Scope of Work",
    ...
    sort_order: 3,
    content:
      "Price is based on the full bill of materials as listed. Partial orders or split releases will not be accepted and will require a revised quote. No deviations will be honored without prior written approval.",
  },
  // Installation
  {
    ...
    sort_order: 1,
    content:
      "This estimate includes only the cost of goods or materials. It does not cover any services, such as product assembly, on-site installation, configuration, or programming.",
  },
  {
    group_name: "Installation",
    title: "Assembly – LED Panels",
    sort_order: 2,
...
export async function POST(
  ...
  if (!group_name || !title || !content) {
    res
      .status(400)
      .json({ error: "group_name, title, and content are required" });
    return;
  }
  const client = DB();
  try {
