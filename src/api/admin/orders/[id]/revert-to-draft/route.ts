...
export async function POST(req: MedusaRequest, res: MedusaResponse) {
    ...
    try {
        ...
        if (qbInFlight || !isLastInSequence) {
            ...
            console.log(`[revert-to-draft] ⚠️ Order ${id} (${docNumber}) closed — reason: ${reason}. Frontend will duplicate as estimate.`)
        ...
        return res.status(200).json({ action: 'reverted', document_number: newDocNumber })
