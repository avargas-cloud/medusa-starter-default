 ...
 */
export async function insertIntoGmailSent(opts: GmailInsertOptions): Promise<void> {
    ...
    try {
        ...
        console.warn(`[gmail-sent] Failed to insert (Resend delivery unaffected): ${message}`)
    }
}
