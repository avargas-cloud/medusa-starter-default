...
export class AddUpdatedAtToQbPipeline1774900000000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP TRIGGER IF EXISTS trg_qb_pipeline_updated_at ON qb_order_pipeline`)
        await queryRunner.query(`DROP FUNCTION IF EXISTS fn_qb_pipeline_touch_updated_at()`)
        ...
        await queryRunner.query(`ALTER TABLE qb_order_pipeline DROP COLUMN IF EXISTS updated_at`)
    }
}
