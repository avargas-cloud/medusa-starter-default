...
export class CreateQuickBooksLog1740780000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_qb_sync_log_order_id ON qb_sync_log(order_id)`)
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_qb_sync_log_display_id ON qb_sync_log(order_display_id)`)
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_qb_sync_log_status ON qb_sync_log(status)`)
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_qb_sync_log_operation ON qb_sync_log(operation)`)
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_qb_sync_log_initiated ON qb_sync_log(initiated_at DESC)`)
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_qb_sync_log_operation_id ON qb_sync_log(operation_id)`)
