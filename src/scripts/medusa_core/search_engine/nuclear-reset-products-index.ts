...
export default async function nuclearResetProductsIndex({
  container,
}: ExecArgs) {
  ...
  try {
    console.log(
      `... Deleting index '${indexName}' entirely matching Tutor recommendation`
    );
  ...
  console.log(
    "✅ NUCLEAR RESET COMPLETE. Index is fresh and schema is locked."
  );
}
