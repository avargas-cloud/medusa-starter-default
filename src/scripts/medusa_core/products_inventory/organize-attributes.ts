...
const ATTRIBUTE_MAPPING = {
  "Electrical Characteristics": [
    "pa_input-voltage",
    "pa_output-voltage",
    "pa_current-per-channel",
    "pa_maximum-current",
    "pa_rated-current",
    "pa_power-consumption",
    "pa_rated-power",
    "pa_wattage",
    "pa_power-per-foot",
    "pa_power-per-meter",
    "pa_led-power-limit",
    "pa_recommended-power-limit",
    "pa_elv-power-limit",
    "pa_mlv-power-limit",
    "pa_cfl-power-limit",
    "pa_inc-halogen-power-limit",
    "pa_phase",
    "pa_frequency-rating",
    "pa_load-type",
    "pa_driver-type",
    "pa_ballast-compatible",
    "pa_interrupt-rating",
  ],
  ...
  "Lighting Characteristics": [
    ...
    "pa_chip-type",
    "pa_modules-count",
    "pa_maximum-led-lines",
    "pa_strip-width",
    "pa_cuttable-length",
    "pa_cutout",
    "pa_totally-enclosed-fixture",
  ],
  ...
  "Control & Compatibility": [
    "pa_dimmable",
    "pa_dimmer-compatibility",
    "pa_compatible-dimmer-type",
    "pa_control-distance",
    "pa_controllable-by",
    "pa_remote-controller",
    "pa_remote-control-mounting",
    "pa_hand-held-remote-compatible",
    "pa_pairing-method",
    "pa_app-compatible",
    "pa_app-name",
    "pa_connection",
    "pa_connection-type",
    "pa_strip-compatibility",
    "pa_compatible-products",
    "pa_input-cable",
    "pa_number-of-wires",
    "pa_number-of-poles",
    "pa_number-of-gangs",
    "pa_number-of-receptacles",
    "pa_number-of-usbs",
    "pa_socket-type",
  ],
  ...
  "Certifications & Ratings": [
    ...
    "pa_ic-rated",
    "pa_airtight",
    "pa_suitable-for-damp-location",
    "pa_suitable-for-wet-location",
    "pa_explosion-proof",
    "pa_tamper-resistant",
    "pa_temperature-rating",
    "pa_environmental-conditions",
    "pa_class-2",
    "pa_class-ii",
  ],
...
export default async function organizeAttributes({ container }: ExecArgs) {
  try {
    ...
    const service: ProductAttributesService = container.resolve(
    ...
    for (const [setName, legacySlugs] of Object.entries(ATTRIBUTE_MAPPING)) {
      ...
      if (!set) {
        console.error(
          `   ❌ FAIL: Could not find or create set "${setName}". Skipping.`
        );
        continue;
      }
