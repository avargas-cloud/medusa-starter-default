...
const strategies = [
  ...
  {
    name: "SSL with sslmode=require in URL",
    config: { connectionString: `${baseUrl}?sslmode=require` },
  },
  {
    name: "SSL with sslmode=disable in URL",
    config: { connectionString: `${baseUrl}?sslmode=disable`, ssl: false },
  },
];
