...
export const BRIDGE_URL = process.env.QB_BRIDGE_URL || 'https://ecopower-qb.loca.lt';
...
export async function qbRequest(method: string, path: string, body?: any): Promise<any> {
...
export async function waitForOp(opId: string, label: string, intervalMs = 5000): Promise<any> {
