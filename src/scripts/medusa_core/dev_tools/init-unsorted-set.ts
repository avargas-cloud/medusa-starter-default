...
export default async function ({ container }: ExecArgs) {
  ...
  console.log(
    "🚀 Creating 'Unsorted Attribute Set' and assigning all attributes...\n"
  );
  ...
  try {
    ...
    console.log(
      `   📌 ${unassignedAttributes.length} attributes are unassigned`
    );
    ...
    console.log(
      `✅ Successfully assigned ${unassignedAttributes.length} attributes!\n`
    );
