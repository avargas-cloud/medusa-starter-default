...
async function main() {
    ...
    for (const row of rows.rows) {
        ...
        console.log(`  transaction_total:             ${totals?.transaction_total?.value ?? totals?.transaction_total}`)
        console.log(`  accounting_total:              ${totals?.accounting_total?.value ?? totals?.accounting_total}`)
    }
