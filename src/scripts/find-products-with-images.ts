...
async function findProductsWithImages() {
    ...
    try {
        ...
        if (result.rows.length > 0) {
            ...
            console.log(`curl -H "x-publishable-api-key: pk_519e7f66680afc4ab0136ce701a7f6d1e8df2b8fc48a29b7a55616a05cb5b5f3" "http://localhost:9000/store/products/${result.rows[0].id}/with-prices"`);
        }
