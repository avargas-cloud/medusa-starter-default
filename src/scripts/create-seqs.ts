...
export default async function ({ container }: { container: MedusaContainer }) {
    ...
    await pg.raw(`CREATE SEQUENCE IF NOT EXISTS custom_sales_receipt_seq START 10000;`)
    await pg.raw(`CREATE SEQUENCE IF NOT EXISTS custom_credit_memo_seq START 1000;`)
