...
async function runTest() {
    ...
    const res = await pool.query(`SELECT id, display_id FROM "order" WHERE display_id = 10060 AND deleted_at IS NULL`)
    ...
    console.log("Success! Updated shipping address:", data.order.shipping_address)
