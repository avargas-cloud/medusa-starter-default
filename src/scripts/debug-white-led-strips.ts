...
async function main() {
    ...
    console.log(`✅ Found category: ${whiteStripsCategory.name} (${whiteStripsCategory.id})`)
    ...
    console.log(`\n📊 Category metadata:`)
    console.log(`   available_attributes: ${whiteStripsCategory.metadata?.available_attributes?.length || 0}`)
