 ...
 *
 * Verifies Fase 0+1 of DELIVERY_FULFILLMENT_INTEGRATION_PLAN.md:
 *  1. DeliveryStatus state machine invariants (pure, no I/O).
 *  2. Registry resolution + safe-by-default token mode.
 ...
 * Skip the live API leg with SKIP_SHIPPO_E2E=1.
 */
