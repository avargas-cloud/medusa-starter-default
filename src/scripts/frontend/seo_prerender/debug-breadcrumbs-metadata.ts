...
async function debugBreadcrumbs() {
  ...
  console.log(
    JSON.stringify(product.metadata?.main_category_breadcrumbs, null, 2)
  );
  console.log(
    "Count:",
    product.metadata?.main_category_breadcrumbs?.length || 0
  );
  ...
  console.log("\nBreadcrumbs from DB:");
  console.log(
    JSON.stringify(dbResult.metadata?.main_category_breadcrumbs, null, 2)
  );
  console.log(
    "Count:",
    dbResult.metadata?.main_category_breadcrumbs?.length || 0
  );
