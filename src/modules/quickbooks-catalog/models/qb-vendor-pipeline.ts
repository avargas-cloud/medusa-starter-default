...
export const QbVendorPipeline = model.define("qb_vendor_pipeline", {
  ...
  // DB BIGSERIAL. Declared so query.graph returns it (# column). The DML hook
  // sends NULL on insert under MikroORM 6.6 — trigger trg_*_seq_default fills it
  // (Migration20260910120000). Never pass it explicitly.
