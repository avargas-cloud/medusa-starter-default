...
export async function generateFiltersForCategory(
  ...
  console.log(
    `[FILTER-GEN] Category: ${categoryId}, Active filters: ${activeFilterIds.length}`
  );
  ...
  console.log(
    `[FILTER-GEN] Including ${descendantIds.length} descendant categories`
  );
  ...
  console.log(
    `[FILTER-GEN] Found ${totalProducts} published products in category ${categoryId} (including ${descendantIds.length} descendants)`
  );
