import { ProductShape, resolveVariantThumbnails } from "../resolve";
...
describe("resolveVariantThumbnails", () => {
  ...
  it("returns update for each variant with a unique image", () => {
    const p = product("p1", "generic.jpg", [
      variant("v1", null, [
        img("img1", "bronze.jpg"),
        img("shared", "shared.jpg"),
      ]),
      variant("v2", null, [
        img("img2", "graphite.jpg"),
        img("shared", "shared.jpg"),
      ]),
      variant("v3", null, [
        img("img3", "magnesium.jpg"),
        img("shared", "shared.jpg"),
      ]),
    ]);
  ...
  it("returns empty when all images are shared across variants", () => {
    const p = product("p1", "generic.jpg", [
      variant("v1", null, [
        img("shared1", "photo1.jpg"),
        img("shared2", "photo2.jpg"),
      ]),
      variant("v2", null, [
        img("shared1", "photo1.jpg"),
        img("shared2", "photo2.jpg"),
