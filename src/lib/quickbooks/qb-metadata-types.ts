...
export function getEstimateTxnId(
...
export function getEstimateRef(
  meta: Record<string, any> | null | undefined
): string | undefined {
  if (!meta) return undefined;
  if (
...
export function getSoRef(
  ...
  if (
    meta.qb_sales_order &&
    typeof meta.qb_sales_order === "object" &&
    meta.qb_sales_order.ref_number
  ) {
...
export function getSoOperationId(
  meta: Record<string, any> | null | undefined
): string | undefined {
  if (!meta) return undefined;
  if (
    meta.qb_sales_order &&
    typeof meta.qb_sales_order === "object" &&
    meta.qb_sales_order.operation_id
  ) {
...
export function getLatestInvoiceTxnId(
  meta: Record<string, any> | null | undefined
): string | undefined {
  if (!meta) return undefined;
...
export function getLatestInvoiceRef(
  meta: Record<string, any> | null | undefined
): string | undefined {
  if (!meta) return undefined;
  const arr = meta.qb_invoices;
...
export function getLatestPaymentTxnId(
  meta: Record<string, any> | null | undefined
): string | undefined {
  if (!meta) return undefined;
...
export function getLatestPaymentRef(
  meta: Record<string, any> | null | undefined
): string | undefined {
  if (!meta) return undefined;
  const arr = meta.qb_payments;
...
export function buildSaleOrderPatch(
  ...
  return {
    ...
    qb_sync_status:
      opts.syncStatus ?? existingMeta.qb_sync_status ?? "sales_order",
