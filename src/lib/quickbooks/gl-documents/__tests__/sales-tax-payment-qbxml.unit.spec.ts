 ...
 * exactamente esa forma, en el orden del schema qbXML 13.0.
 */
describe("SalesTaxPaymentCheckAdd qbXML", () => {
  ...
  it("without a RefNumber it emits IsToBePrinted=false (the two are mutually exclusive in the schema)", () => {
    ...
    expect(xml).toContain("<BankAccountRef><ListID>80000167-1684269278</ListID></BankAccountRef><IsToBePrinted>false</IsToBePrinted><Memo>");
