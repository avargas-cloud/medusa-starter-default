  ...
  for (const variant of variants) {
    ...
    if (!variant.inventory_items || variant.inventory_items.length === 0) {
      ...
      docs.push({
        ...
        purchaseCost: (vmeta.purchase_cost as number) || (vmeta.qb_purchase_cost as number) || null,
        cost: (vmeta.average_cost as number) || (vmeta.purchase_cost as number) || (vmeta.qb_purchase_cost as number) || null,
