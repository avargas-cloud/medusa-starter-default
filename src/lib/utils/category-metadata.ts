 ...
 */
export function cleanMetadataForStore(metadata: CategoryMetadata | null | undefined): CategoryMetadata {
    if (!metadata) return {}
 ...
 */
export function cleanCategoriesForStore<T extends { metadata?: CategoryMetadata }>(
    categories: T[]
): T[] {
