...
export const updatePosProductWorkflow = createWorkflow(
    ...
    function (input: UpdatePosProductInput) {
        ...
        if (input.title || input.salesDescription) {
            ...
            if (input.salesDescription) updatePayload.description = input.salesDescription
        }
        ...
        if (input.country_of_origin !== undefined) variantPayload.origin_country = input.country_of_origin
