...
export default async function syncInvoice({ container }: { container: MedusaContainer }) {
    ...
    logger.info(`Finished triggering subscriber! Check the Quickbooks bridge queue now.`)
}
