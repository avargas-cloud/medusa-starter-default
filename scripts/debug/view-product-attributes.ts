...
if (!productIdentifier) {
    console.error("❌ Usage: npx tsx scripts/debug/view-product-attributes.ts [product-handle-or-id]")
    process.exit(1)
}
...
async function main() {
    ...
    console.log("\n" + "─".repeat(80))
    console.log(`✅ Total: ${product.attribute_values.length} attribute values across ${grouped.size} attribute keys\n`)
}
