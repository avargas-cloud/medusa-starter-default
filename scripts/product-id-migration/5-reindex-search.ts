...
async function main() {
    ...
    try {
        ...
        console.log("  2. The MeiliSearch plugin will auto-index all products with new IDs")
        ...
        if (error.message?.includes('ECONNREFUSED')) {
            ...
            console.log("  curl -X DELETE 'http://localhost:7700/indexes/products/documents' \\")
